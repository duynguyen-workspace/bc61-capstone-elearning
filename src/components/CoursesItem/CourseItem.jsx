            ...
            <div className="courseItem__item w-[1170px] mx-auto">
                <div className="courseItem__title ">
                    ...
                    <p className="text-[#8e88a8] leading-6">
                        Embark on a journey of knowledge and skill development
                        with our online course marketplace. Discover a diverse
                        array of expert-led courses designed to empower and
                        enrich your learning experience. From professional
                        development to personal growth, explore our curated
                        selection of online courses that cater to your unique
                        aspirations.
                    </p>
                </div>
